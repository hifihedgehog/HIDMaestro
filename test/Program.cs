...
class Program
{
    ...
    static int Main(string[] args)
    {
        ...
        // Read-only introspection commands run fine without admin.
        bool readOnlyCmd = args.Length > 0 && args[0].ToLowerInvariant() is "list" or "search" or "info" or "probe-xusb" or "xusb-vibrate";
        ...
        // Elevate — every non-read-only command needs admin (device create / driver install / cleanup)
