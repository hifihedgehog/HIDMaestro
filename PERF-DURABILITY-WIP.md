...
| Metric | v1.2.2 dev box | v1.3.0 dev box | Atom (projected ×10) | Atom (measured) |
|---|---|---|---|---|
| Warm-launch 3-controller create (xbox360 + xbox-bt + dualsense) | **1 287 ms** Phase 1 | _pending_ | ~13 s | _pending_ |
|   ↳ Xbox 360 wired (XUSB companion path) | 693 ms | _pending_ | ~7 s | _pending_ |
|   ↳ Xbox Series BT (xinputhid path) | 166 ms | _pending_ | ~1.7 s | _pending_ |
|   ↳ DualSense BT (plain HID path) | 427 ms | _pending_ | ~4 s | _pending_ |
| Finalize device names | 2 ms | _pending_ | ~20 ms | _pending_ |
| 3-controller teardown total | **35 732 ms** ⚠ | _pending_ | _huge_ | _pending_ |
|   ↳ DualSense BT (slot 2) | 5 596 ms | _pending_ | ~56 s | _pending_ |
|   ↳ Xbox Series BT (slot 1, xinputhid) | 5 736 ms | _pending_ | ~57 s | _pending_ |
|   ↳ Xbox 360 wired (slot 0, XUSB companion) **OUTLIER** | **35 726 ms** ⚠ | _pending_ | _hours_ | _pending_ |
| swap_regression battery wall | 2 016 s | _pending_ | ~5–6 hours | _pending_ |
| swap_regression battery PASS count | 26/26 | _pending_ | _pending_ | _pending_ |
